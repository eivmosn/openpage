...
import type { UiAdapter, UiNodeProps } from '../types'

export type AdapterComponent = Component | string

export type AdapterPropsResolver = (props: UiNodeProps) => Record<string, unknown>

export type AdapterValueResolver = (props: UiNodeProps) => unknown

export type AdapterUpdateValueResolver = (args: unknown[], props: UiNodeProps) => unknown
...
export interface CreateButtonComponentOptions {
  ...
  disabledProp?: string | false
  resolveProps?: AdapterPropsResolver
  resolveText?: (props: UiNodeProps) => unknown
}
